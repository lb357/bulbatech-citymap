...
| GET | /api/feed | ?page=int&category=int | | {"page": int, "category": int, "tickets": [{"title": str, "ticket_id": int, "category": int, "pinned": bool}, ...]} | |
...
| GET | /api/tickets | ?page=int | | {"page": int, "user_id": int, "tickets": [{"title": str, "ticket_id": int, "category": int, "pinned": bool}, ...]} | |
