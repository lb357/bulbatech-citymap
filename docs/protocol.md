...
| GET | /api/ticket | ?ticket_id=int | | {"ticket_id": int, "icon": str(UNICODE), "title": str, "category": int, "text": str, "files": [str(url), ...] "user_id": int, "likes": [int, ...] (user_id), "dislikes": [int, ...] (user_id), "official_comment": str, "comments": [ {"user_id": int, "text": str}, ... ], "point": [float, float], "pinned": bool, "timestamp": int, "archive": bool} | |
